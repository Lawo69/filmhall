  ...
  return (
    <div className='bg-black-secondary'>
      <div className='container mx-auto flex flex-col gap-4 py-14 px-6 md:px-8 lg:px-10'>
        <div className='flex flex-col lg:flex-row gap-5 lg:items-center justify-between border-b pb-4'>
          <h1 className='font-dinAlternate text-3xl font-medium'>Collect your favourites</h1>
        ...
        {results.length > 0 && (
          <>
            <h2 className="text-xl text-white mt-8">Search Results</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
              {results.map(movie => (
                <MovieCard
                  key={movie.id}
